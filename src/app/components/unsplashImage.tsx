  ...
  return (
    <div className='relative w-full h-full'>
      ...
      <div className='absolute bottom-1 w-full px-2 text-xs flex flex-col items-end justify-center'>
        <a className=' text-white mb-0.5' href={links.html} target='_blank'>Unsplash</a>
        <a className="cursor-pointer flex items-center bg-gray-100 rounded-full px-1 py-0.5" href={user.links.html} target='_blank'>
